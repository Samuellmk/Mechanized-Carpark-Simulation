...
class StatsBox:
    ...
    def calculate_waiting_time(self):
        self.stats["Avg. Parking Waiting Time"] = round(np.mean(self.waiting_stats["parking"]), 3)
        self.stats["Avg. Retrieval Waiting Time"] = round(np.mean(self.waiting_stats["retrieval"]), 3)
